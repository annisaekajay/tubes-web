...
<nav class="navbar navbar-expand-lg navbar-light bg-dark ">
        <div class="container-fluid">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
           <li><a class="dropdown-item" href="../kategoripolitikpage.php">Kesehatan</a></li>
            <li><a class="dropdown-item" href="../kategorimakananpage.php">Sosial</a></li>
        ...
        <div class="row justify-content-center">
            ...
            <div data-aos="fade-down">
                <div class="card">
                    ...
                    <img src="../anggota/chic.jpeg" class="card-img-top" alt="Chic | Ridha" style="height:300px; width:300px">
                    </div>
                    <div class="flip-card-back">
                        <p class="fw-bold">Annisa | Ridha</p>
                        <p class="fw-bold">60900121003 | 60900121056</p>
                    </div>
                    </div>
                </div>
            </div> 
            ...
            <div data-aos="fade-right">
              <h3>Belajar pemrograman itu harus fokus guys, salah penulisan atau tanda petik saja bisami bikin nangis-nangis sepanjang hari </h3>
            </div>
  </div>
        </div>
    </div>
  ...
  <div class="text-center text-white p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2023 Copyright:
    <a class="text-white" style="text-decoration:none;">Kelompok 9</a>
  </div>
